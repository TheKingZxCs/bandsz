...
v0.new("<Color=Cyan>Welcome To Vonix Hax<Color=/>"):Display();
wait(0.5);
v0.new("<Color=Yellow>Join Discord For Update!<Color=/>"):Display();
wait(1);
repeat
	wait();
...
local v69 = v66:T("Settings Other", "rbxassetid://10734950309");
...
game:GetService("StarterGui"):SetCore("SendNotification", {
	Title = "Vonix H4X",
	Text = "Loading...",
	Icon = "rbxthumb://type=Asset&id=116903283229388&w=150&h=150",
	Duration = 10
});
spawn(function()
	while wait() do
